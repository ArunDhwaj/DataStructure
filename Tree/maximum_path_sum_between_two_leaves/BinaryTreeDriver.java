/**
@file: BinaryTreeDriver.java
@author: Arun Dhwaj,
@date: 1st Aug, 2018
@purpose: Java program to find maximum path sum between two leaves of a binary tree 
**/

import MaxSumLib.Node;
import MaxSumLib.Res;
...
public class BinaryTreeDriver
{
    ...
    */
    ...
    {
        BinaryTreeDriver tree = new BinaryTreeDriver();
        ...
        tree.root.right.right.right.left = new Node(34);
